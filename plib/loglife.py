...
#
# with sudo crontab -e
#      @reboot /home/pi/pi5desk/utils/nohup_loglife.py
# touch /home/pi/pi5desk/logs/life.log
# chmod 777 /home/pi/pi5desk/logs/life.log
#

import time
import sys
sys.path.insert(1,"/home/pi/pi5desk/plib/")
...
loghandler = logging.FileHandler('/home/pi/pi5desk/logs/life.log')
